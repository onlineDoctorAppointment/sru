...
<body>
    <div class=" w3l-login-form">
        ...
        <p class=" w3l-register-p">Don't have an account?<a href="pat_reg.php"  target="_self" class="register" > Sign UP</a></p>
    </div>
...
if(sizeof($ar)>0){
	...
	foreach ($ar as $val) {
		...
		if($val['type']=='user')
		{
            ...
            echo "<script>window.location=('./patient/pat_pro.php')</script>";
