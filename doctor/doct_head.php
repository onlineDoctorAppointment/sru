		...
		<nav id="nav" class="navbar">
			...
			<marquee behavior="scroll" direction="left">DEVIMATHA HOSPITAL,RAJAKUMARY</marquee>
				...
				<ul class="main-nav nav navbar-nav navbar-right">
					<li> <a href="doct_pro.php"><i class="fa fa-user-circle"> <?php echo $_SESSION['ulp'];?> </i></a></li>
...
<div class="sidenav">
  ...
  <a href="doct_pro.php"><i class="fa fa-user-circle"></i> Profile  </a>
  
  <a href="req_appointment.php"><i class="fa fa-address-book-o"></i>Appointments </a>
