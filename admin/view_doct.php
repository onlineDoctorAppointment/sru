...
<?php
    ...
    $ar=mysqli_query($al, "SELECT * FROM doct  INNER join specilization USING (spelz_id) order by doct_name asc");
$i=1;
...
<input type="" id="myInput" name="text" class="se" placeholder="search Doctors here.."><th style="padding:10px;margin-left:10px;" ><img style="width:30px;height:30px;" src="../img/se.jpg" ></th><td style="padding:10px">
		...
		<tr>
		<th>SI/No:</th>	<th>Doctor's </th><th>Specilization</th><th >Contact</th><th >Working <br>Time</th><th >Consultation Fee</th><th >Update</th>
			</tr>
			<tbody id="myTable">
      ...
      <td><?php echo $i++;?> </td>
       ...
       <td><a href='doct_update.php?doct_id=<?php  echo $qw['doct_id']; ?>' ><img style="width:80px;height:80px;" src='../img/up.jpg'></a> </td>
