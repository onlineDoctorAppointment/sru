...
.fa-user-md,.fa-user-circle,.fa-medkit,.fa-address-book-o{
    float: left;
  padding-right: 18px;
...
<body>
	...
	<header>
        ...
        <ul class="main-nav nav navbar-nav navbar-right">
					<li> <a href="###"><i class="fa fa-user-circle"> <?php echo  $_SESSION['ulp'];?> </i></a></li>
...
<div class="sidenav">
  ...
  <a href="admin_home.php"><i class="fa fa-user-circle"></i> Home  </a>
  <button class="dropdown-btn">Doctor
  <i class="fa fa-user-md"></i>
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
    <a href="add_doct.php">Add Doctor</a>
    <a href="view_doct.php">View Doctor</a>
    <a href="splz.php">Specilization</a>
  </div>
  <a href="view_patient.php"><i class="fa fa-address-book-o"></i> patient</a>
  <a href="appoint.php"> </a>
  <button class="dropdown-btn">Appointment
  <i class="fa fa-address-book-o"></i>
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container">
    <a href="aprv_appo.php">Approve Appointment</a>
    <a href="aprved_app.php">Approved Appointment </a>
    <a href="appoint.php">Appointment History</a>
