...
<?php
    ...
    $ar=mysqli_query($al, "SELECT * FROM appointment  INNER join doct USING (doct_id) WHERE pat_id=$ii AND status='approved' order by appo_id DESC");
$i=1;
...
<h2 align="center"><b> Approved appointments </b></h2>
<input type="" id="myInput" name="text" class="se" placeholder="search Patients here.."><th style="padding:10px;margin-left:10px;" ><img style="width:30px;height:30px;" src="../img/se.jpg" ></th><td style="padding:10px">
		...
		<tr>
		<th>SI/No:</th>	<th>Doctor's</th><th>Taken date</th><th>Appointment Date</th><th>Status</th><th >Purpose</th><th >print</th>
			</tr>
			<tbody id="myTable">
      ...
      <?php $tr=date('d-m-Y',strtotime($qw['app_take_date'])); ?>
               ...
               <?php $sr=date('d-m-Y',strtotime($qw['appo_date'])); ?>
                ...
                <td><a href="print_app.php?appo_id=<?php echo $qw['appo_id']?>">
       <b>Print</b> </a></td>
